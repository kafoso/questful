...
class PdoMySql5_5Test extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataProvider_testGenerateForAllFilterTypesAndCases()
    {
        return [
            ...
            [Allowable\Filter\AllowedInFilter::class, "foo=[null,true,false,1,3.14,\"bar\"]", "(t.foo IN (:filter_0_1, :filter_0_2, :filter_0_3, :filter_0_4, BINARY :filter_0_5) OR t.foo IS NULL)", ["filter_0_0" => null, "filter_0_1" => true, "filter_0_2" => false, "filter_0_3" => 1, "filter_0_4" => 3.14, "filter_0_5" => "bar"]],
        ];
    }
