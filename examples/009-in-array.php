 ...
 *
 * Usage: php 009-in-array.php <URL>
...
if (false == isset($argv[1])) {
    echo "Please provide a URL as the 2nd argument. E.g.: php 009-in-array.php '?filter[]=name=[\"fOO\", \"bAr\"]/i'" . PHP_EOL;
    return false;
}

$databaseFilePathAbsolute = __DIR__ . "/resources/__generated/009-in-array.db";
...
try {
    ...
    $mapping
        ...
        ->allow(new Allowable\Filter\AllowedInFilter("timeCreated"))
        ->allow(new Allowable\Filter\AllowedInFilter("name"))
        ->validate();
